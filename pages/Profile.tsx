...
const Profile: React.FC<ProfileProps> = ({ onBack, onFeedClick, onHomeClick, onFavoritesClick }) => {
  const achievements = [
    ...
    { id: 3, icon: 'local_fire_department', label: 'Expert em Tocha', color: 'bg-orange-100 text-orange-600' },
  ];

  const menuItems = [
    { icon: 'edit', label: 'Editar Perfil', sub: 'Nome, foto e bio' },
    { icon: 'workspace_premium', label: 'Certificados', sub: '6 cursos concluídos' },
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark pb-32">
      ...
      <div className="flex flex-col items-center pt-6 pb-8 px-6">
        ...
        <p className="text-primary font-bold text-sm bg-primary/10 px-3 py-1 rounded-full mt-2">Confeiteira Expert</p>
      </div>
